...
RUN composer config --json --merge policy.advisories.ignore-id '{"PKSA-xwpn-zs9j-6wy5":"Plugin requires specific version","PKSA-sf9j-1gs7-xzvx":"Plugin requires specific version","PKSA-7h5p-prw9-w5nr":"Plugin requires specific version","PKSA-2dkq-4nxk-nkts":"Plugin requires specific version","PKSA-8djr-jy87-r26y":"Plugin requires specific version"}' && \
